...
export let YoutubeMediaMock = {
  ...
  snippet: {
    ...
    description:
      "\"Dust\" Presale Available NOW - https://fret12.com/store/tremonti-dust 'Dust' is Tremonti's follow up record to their 2015 FRET12 release 'Cauterize'. Get all the ...",
    thumbnails: {
      default: {
