...
export const getUserPlaylists = createSelector(
  getUser,
  (user: IUserProfile) => user.playlists
);
export const getUserViewPlaylist = createSelector(
  getUser,
  (user: IUserProfile) => user.viewedPlaylist
);
export const getIsUserSignedIn = createSelector(
  getUser,
  (user: IUserProfile) => user.access_token !== ''
);
